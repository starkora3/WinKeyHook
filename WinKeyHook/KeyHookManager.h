...
namespace MYKEYHOOK
{
	...
	*/
	...
	public:
		...
		virtual void AddLogMessage(LPCTSTR str) = 0;
	};
	...
	*/
	...
	{
	public:
		static CKeyHookManager* Instance();
		...
		//! リスナー登録
		void SetListener(IKeyHookListener* p){ m_pListener = p; };

		static BOOL GetLastErrorString(DWORD dwErrorNo, std::wstring& strErr);

	protected:
		CKeyHookManager();	//!< コンストラクタ
	...
	public:
		//! Log
		void AddLogMessage(LPCTSTR str);
	};
